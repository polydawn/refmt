...
func testNumber(t *testing.T) {
	t.Run("integer zero", func(t *testing.T) {
		seq := fixtures.Sequence{"integer zero", []Token{{Type: TInt, Int: 0}}}
		canon := deB64("AA==")
	...
	t.Run("integer zero unsigned", func(t *testing.T) {
		seq := fixtures.Sequence{"integer zero unsigned", []Token{{Type: TUint, Uint: 0}}}
		canon := deB64("AA==")
		t.Run("encode canonical", func(t *testing.T) {
			checkEncoding(t, seq, canon, nil)
		})
	...
	t.Run("integer one", func(t *testing.T) {
		seq := fixtures.Sequence{"integer one", []Token{{Type: TInt, Int: 1}}}
		canon := deB64("AQ==")
		t.Run("encode canonical", func(t *testing.T) {
			checkEncoding(t, seq, canon, nil)
		})
	...
	t.Run("integer one unsigned", func(t *testing.T) {
		seq := fixtures.Sequence{"integer one unsigned", []Token{{Type: TUint, Uint: 1}}}
		canon := deB64("AQ==")
		t.Run("encode canonical", func(t *testing.T) {
			checkEncoding(t, seq, canon, nil)
		})
	...
	t.Run("integer neg 1", func(t *testing.T) {
		seq := fixtures.Sequence{"integer neg 1", []Token{{Type: TInt, Int: -1}}}
		canon := deB64("IA==")
		t.Run("encode canonical", func(t *testing.T) {
			checkEncoding(t, seq, canon, nil)
		})
	...
	t.Run("integer neg 100", func(t *testing.T) {
		seq := fixtures.Sequence{"integer neg 100", []Token{{Type: TInt, Int: -100}}}
		canon := deB64("OGM=")
		t.Run("encode canonical", func(t *testing.T) {
			checkEncoding(t, seq, canon, nil)
		})
	...
	t.Run("integer 1000000", func(t *testing.T) {
		seq := fixtures.Sequence{"integer 1000000", []Token{{Type: TInt, Int: 1000000}}}
		canon := deB64("GgAPQkA=")
		t.Run("encode canonical", func(t *testing.T) {
			checkEncoding(t, seq, canon, nil)
		})
	...
	t.Run("integer 1000000 unsigned", func(t *testing.T) {
		seq := fixtures.Sequence{"integer 1000000 unsigned", []Token{{Type: TUint, Uint: 1000000}}}
		canon := deB64("GgAPQkA=")
		t.Run("encode canonical", func(t *testing.T) {
			checkEncoding(t, seq, canon, nil)
		})
	...
	t.Run("float 1 e+100", func(t *testing.T) {
		seq := fixtures.Sequence{"float 1 e+100", []Token{{Type: TFloat64, Float64: 1.0e+300}}}
